...
import {BehaviorSubject, concat, Observable, merge, zip} from 'rxjs';
...
import { BackendErrorResponse } from 'shared/types/backend-error-response';
...
export class UploadQueueService {
    ...
    public start(files: UploadedFile[], config: UploadApiConfig = {}): Observable<FileEntry> {
        ...
        this.uploads$.next(uploads as UploadQueueItem[]);
    ...
    public completeUpload(id: string, fileEntry: FileEntry) {
        ...
        queueItem.fileEntry.queue_id = queueItem.id;
        queueItem.complete();
    }
