...
import {WpUtils} from 'app/web-player/web-player-utils';
...
import {PlaylistTrackContextMenuComponent} from 'app/web-player/playlists/playlist-track-context-menu/playlist-track-context-menu.component';
import {UploadedTrackContextMenuComponent} from 'app/web-player/users/user-library/library-uploaded/uploaded-context-menu/uploaded-context-menu.component';
...
export class TrackListComponent implements OnInit, OnChanges, OnDestroy {
    ...
    private getContextMenuComponent() {
        ...
        } else if (this.contextMenuParams.type === 'uploadedTrack') {
            return UploadedTrackContextMenuComponent;
        } else {
