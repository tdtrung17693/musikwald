...
import {Pages} from 'shared/pages/pages.service';
...
import {ArtisanService} from '@app/admin/artisan.service';
import {SettingsPayload} from 'shared/config/settings-payload';
