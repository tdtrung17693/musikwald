...
Route::group(['prefix' => 'secure'], function () {
    ...
    Route::get('tracks/pending', 'TrackController@pendingTracks');
    ...
    //REPORTS
    Route::post('tracks/{id}/report', 'ReportController@store');
    Route::get('reports', 'ReportController@index');
    Route::put('reports/{id}', 'ReportController@update');
    Route::delete('reports', 'ReportController@destroy');
    ...
    Route::get('user/library/uploaded-tracks', 'UserLibrary\UserLibraryTracksController@uploadedTracks');
    Route::post('user/library/uploaded-tracks/remove', 'UserLibrary\UserLibraryTracksController@uploadedTracksRemove');
...
Route::get('genres', 'PopularGenreController@index')->middleware('prerenderIfCrawler');
